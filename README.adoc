...
http://getreu.net/public/downloads/doc/asciidoctor-notetaking/[getreu.net].
There you also find a
http://getreu.net/public/downloads/doc/asciidoctor-notetaking/README.pdf[pdf
...
+
IMPORTANT: _Editor_ and _viewer_ should be configured to use your default
windows codepage.
+
